...
//                            gongzuorenyuanEntity.setGongzuorenyuanName(data.get(0));                    //社区工作人员名称 要改的
...
//                            gongzuorenyuanEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(gongzuorenyuan.getId(),username, "gongzuorenyuan", "社区工作人员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","社区工作人员");
