...
//                            jianliEntity.setJianliUuidNumber(data.get(0));                    //就业信息唯一编号 要改的
//                            jianliEntity.setJianliName(data.get(0));                    //就业信息名称 要改的
...
//                            jianliEntity.setCreateTime(date);//时间
                        ...
                        if(jianliEntities_jianliUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [就业信息唯一编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //手机号
